                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body delete_modal">
                                       ¿Estás seguro de que quieres borrar el curso <?php echo $row["nombre_curso"];?>?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancelar</button>
                                        <button onclick= "borrar_curso(<?php echo $row['id_curso'];?>)" type="button" class="btn btn-danger">Sí, borrar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
